...
Please see the [availability and pricing]({{ site.baseurl }}/availability) for this gite or [contact us]({{ site.baseurl }}/contacts/) with any questions.

## Downstairs gite

You may also wish to see the [downstairs gite]({{ site.baseurl }}/downstairs). The two gites can be reunited for larger groups, with sleeping for up to 12 - there is room in the downstairs gite for everyone to eat together.
